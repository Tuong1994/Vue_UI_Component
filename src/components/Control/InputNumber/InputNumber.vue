...
const controlValue = computed<string>(() =>
  form?.isVee ? formatNumber(String(veeValue?.value)) : formatNumber(String(props.modelValue))
)
...
const handleChange = (e: Event) => {
  ...
  if (form?.isVee) setValue(Number(inputValue))
